...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    #define DimLevel                    17          // Number from 0-255, with 0 being off, 255 being full on. Often numbers much greater than half (128) are hard to distinguish from full on. 
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    #define TurnFromStartContinue_mS  700           // If BlinkTurnOnlyAtStop = true, this setting determines the length of time the turn signal will continue to blink when you begin moving from 
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    // 1000 ms = 1 second
    #define TimeToStop_FWD_mS          0          // An estimate of the time usually spent coasting to a stop from forward. During this time, reverse commands will be counted as braking
    #define TimeToStop_REV_mS          0          // An estimate of the time usually spent coasting to a stop fro reverse. During this time, forward commands will be counted as braking
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    #define TimeToShift_mS             0          // The pause time in milliseconds that will be required before the vehicle is allowed to change direction
