...
{ 
    switch (WhatSetting)
    {
        ...
        case FADEOFF:
            ...
            break;
        case CDIM:
            CustomDimLight(WhatLight);
            break;      
    }
}

// ------------------------------------------------------------------------------------------------------------------------------------------------>  
// CUSTOMDIMLIGHT - Turns a light (custom DIM)
// ------------------------------------------------------------------------------------------------------------------------------------------------>  
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>  
// TURNONLIGHT - Turns a light at PWN level
// ------------------------------------------------------------------------------------------------------------------------------------------------> 

void TurnPwmLight(int WhatLight,int PWM)
{
    analogWrite(LightPin[WhatLight], PWM);
}
